...
//         // According to documentation, status is a query parameter and should use PUT
...
export const contactApi = {
    ...
    async getAdminSubjects(): Promise<ContactSubject[]> {
        try {
            ...
            return [
                { id: '60f1b2b3b3b3b3b3b3b3b3b5', name: 'Course Inquiry', displayName: 'Course Inquiry' },
                { id: '60f1b2b3b3b3b3b3b3b3b6', name: 'Technical Support', displayName: 'Technical Support' }
            ];
        }
    },
